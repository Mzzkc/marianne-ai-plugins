---
name: conducting
description: Use when directing, steering, supervising, recovering, or judging a Marianne score, persistent-agent lifecycle, concert, fleet, or other asynchronous expert performance toward a shared outcome.
---
...
identity and memory; conflicts become explicit agent-adjudicated debt. Push
back when a request would damage the vision, venue, person, or future.
...
keep the debt visible and schedule consolidation/reflection/resurrection, then
prove later recall.

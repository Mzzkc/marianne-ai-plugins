...
Read one row. Load only the reference and optional artifacts needed for the
current performance.
...
| Operate Marianne jobs or commission technical changes | `references/marianne-operations.md` | venue-native status and control artifacts |
